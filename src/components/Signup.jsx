...
const Signup = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <Input type='text' name='name' id='name' placeholder='이름' {...register('name')}/>
        ...
        <Input type='email' name='email' id='email' placeholder='이메일' {...register('email', {required: true, pattern: /^\S+@\S+$/i })}/>
...
{/* 
        ...
        <Input type='text' name='id' id='id' placeholder='아이디' {...register('id', {min: 6, max: 17})}/>
        ...
        <Input type='password' name='password' id='password' placeholder='비밀번호' {...register('password', {required: true, minLength: 6, maxLength: 20,})}/>
        ...
        <Input type='password' name='password' id='password-check' placeholder='비밀번호 확인' />
